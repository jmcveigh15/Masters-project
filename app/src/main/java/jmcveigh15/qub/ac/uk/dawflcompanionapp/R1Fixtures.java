...
public class R1Fixtures extends AppCompatActivity implements FetchR1Fixtures.AsyncResponse, NavigationView.OnNavigationItemSelectedListener {
    ...
    // date textview
    private TextView fixtureDate1, fixtureDate2, fixtureDate3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new FetchR1Fixtures(this).execute();

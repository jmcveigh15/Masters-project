...
public class FetchR2Fixtures extends AsyncTask<Void, Void, ArrayList<String>> {
    ...
    protected ArrayList<String> doInBackground(Void... voids) {
        ...
        try {
            for (int i = 0; i < 50; i++) {
                if (root.data.get(i).competitionName.equals("DAWFL Reserve Division 2")) {
    ...
    FetchR2Fixtures(AsyncResponse delegate) {

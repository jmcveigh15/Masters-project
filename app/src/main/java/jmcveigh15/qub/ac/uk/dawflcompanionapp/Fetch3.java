...
public class Fetch3 extends AsyncTask<Void, Void, ArrayList<String>> {
    ...
    protected ArrayList<String> doInBackground(Void... voids) {
        ...
        try {
            // loop through 50 array objects of json data
            for (int i = 0; i < dataRead.length(); i++) {
                // if comp name is prem div
                if (root.data.get(i).competitionName.equals("DAWFL Premier Division")) {

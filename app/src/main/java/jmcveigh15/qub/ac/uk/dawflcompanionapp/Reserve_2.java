...
public class Reserve_2 extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.Fixtures:
                startActivity(new Intent(this, R2Fixtures.class));
                break;
            case R.id.Table:
                startActivity(new Intent(this, Reserve2Table.class));
                break;
            case R.id.Results:
                startActivity(new Intent(this, R2Results.class));
                break;
        }
    }

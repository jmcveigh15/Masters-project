...
public class Division_2 extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.Fixtures:
                startActivity(new Intent(this, D2Fixtures.class));
                break;
            case R.id.Table:
                startActivity(new Intent(this, D2Table.class));
                break;
            case R.id.Results:
                startActivity(new Intent(this, D2Results.class));
                break;
        }
    }

...
public class Prem extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        name = "Premier Division Hub";
        mDivision = (TextView) findViewById(R.id.Division);
        mDivision.setText(name);


        // declaring buttons and makign them clickable
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.Fixtures:
                startActivity(new Intent(this, PremFixtures.class));
                break;
            case R.id.Results:
                startActivity(new Intent(this, PremResults.class));
                break;
            case R.id.Table:
                startActivity(new Intent(this, PremTable.class));
                break;
        }
    }

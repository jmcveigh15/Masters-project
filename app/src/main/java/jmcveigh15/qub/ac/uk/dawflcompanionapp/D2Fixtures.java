...
public class D2Fixtures extends AppCompatActivity implements FetchD2Fixtures.AsyncResponse, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new FetchD2Fixtures(this).execute();

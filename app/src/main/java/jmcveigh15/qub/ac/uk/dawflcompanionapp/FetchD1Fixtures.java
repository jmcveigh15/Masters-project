...
public class FetchD1Fixtures extends AsyncTask<Void, Void, ArrayList<String>> {
    ...
    public interface AsyncResponse {
        void doInBackground(ArrayList<String> listOfD1Fixtures);
    }
    ...
    protected ArrayList<String> doInBackground(Void... voids) {
        ...
        ArrayList<String> listOfD1FixturesData = new ArrayList<>();
        ...
        try {
            for (int i = 0; i < dataRead.length(); i++) {
                if (root.data.get(i).competitionName.equals("DAWFL Division 1")) {
                    ...
                    listOfD1FixturesData.add(homeTeam);
                    listOfD1FixturesData.add(awayTeam);
                    listOfD1FixturesData.add(venue);
                    listOfD1FixturesData.add(date);
                }
            }
    ...
    @Override
    protected void onPostExecute(ArrayList<String> listOfD1Fixtures) {
        delegate.doInBackground(listOfD1Fixtures);
    }
}

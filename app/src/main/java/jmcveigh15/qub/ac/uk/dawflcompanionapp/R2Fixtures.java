...
public class R2Fixtures extends AppCompatActivity implements FetchR2Fixtures.AsyncResponse, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new FetchR2Fixtures(this).execute();

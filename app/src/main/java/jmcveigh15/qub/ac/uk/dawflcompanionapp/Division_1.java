...
public class Division_1 extends AppCompatActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.Fixtures:
                startActivity(new Intent(this, D1Fixtures.class));
                break;
            case R.id.Table:
                startActivity(new Intent(this, D1Table.class));
                break;
            case R.id.Results:
                startActivity(new Intent(this, D1Results.class));
                break;
        }
    }
